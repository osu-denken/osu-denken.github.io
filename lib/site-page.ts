...
export const SITE_PAGES: readonly SitePage[] = [
  { path: "content/pages/about.md", label: "電研について", kind: "markdown" },
  { path: "content/pages/access.md", label: "アクセス", kind: "markdown" },
  { path: "content/works.json", label: "作品", kind: "works" },
];
