    ...
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          ...
          <br />
          電子計算研究部は昭和43年6月10日に創部され、2018年には創立50周年を迎えました。<br />
          なお、旧部則によると昭和62年4月1日から設立されているとのことです。こちらは公認クラブとしての設立日でしょう。こちらを基準にする場合は来年2027年には設立40周年を迎えます！<br />
          つまり、創部年と設立年の差には19年もありますね！
        </p>
